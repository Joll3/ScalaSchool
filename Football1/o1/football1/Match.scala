...
class Match(val home: Club, val away: Club) {
  ...
  /** Determines if this match is without any goals for either team */
  def isGoalless = if (this.totalGoals == 0) true else false
  ...
  /** Determines whether this match has a higher total score than another given match.
    ...
    */
  def isHigherScoringThan(anotherMatch: Match) = if (this.totalGoals > anotherMatch.totalGoals) true else false
  ...
  if (this.awayCount + this.homeCount == 0) home.name + " vs. " + away.name + " at " + this.location + ": tied at nil-nil"
  else if (this.isTied) home.name + " vs. " + away.name + " at " + this.location + ": tied at " + this.homeGoals + " -all"
  else if (this.homeCount > this.awayCount) home.name + " vs. " + away.name + " at " + this.location + ": " + this.homeCount + "-" + this.awayCount + " to " + this.home.name
  else if (this.homeCount < this.awayCount) home.name + " vs. " + away.name + " at " + this.location + ": " + this.awayCount + "-" + this.homeCount + " to " + this.away.name
  else ""
  }
