...
class Adventure {
  ...
  southForest.setNeighbor("north", middle)
  southForest.setNeighbor("east",  tangle)
  southForest.setNeighbor("south", southForest)
  southForest.setNeighbor("west",  clearing)

  clearing.setNeighbor("north", northForest)
  clearing.setNeighbor("east", middle)
  clearing.setNeighbor("south", southForest)
  clearing.setNeighbor("west", northForest)
  
  tangle.setNeighbor("north", northForest)
  tangle.setNeighbor("east", home)
  tangle.setNeighbor("south", southForest)
  tangle.setNeighbor("west", northForest)
