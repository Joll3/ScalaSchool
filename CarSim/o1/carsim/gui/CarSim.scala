...
object CarSim extends SimpleSwingApplication {
  ...
  def top = new MainFrame {
    ...
    val map = new CarMap(new MapQuestOsmTileSource(), Location(60.186727, 24.822589), 5)
    ...
    this.contents = new BorderPanel {
      ...
      val bottomRow = new BorderPanel {
        val attributions = new FlowPanel(FlowPanel.Alignment.Right)(new Attribution("Directions © Google.", "https://developers.google.com/maps/documentation/directions/"),
                                                                    new Attribution("Map tiles © MapQuest.", "http://www.mapquest.com/"),
                                                                    new Attribution("Map data © OpenStreetMap contributors.", "http://www.openstreetmap.org/copyright"),
