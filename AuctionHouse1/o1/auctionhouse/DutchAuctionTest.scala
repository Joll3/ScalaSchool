...
/** A small program that uses the class `DutchAuction`.
  * May be expanded by the student as desired.
  *
  * Assuming the class `DutchAuction` has been implemented
...
object DutchAuctionTest extends App {
  ...
  val bookSale = new DutchAuction("Programming in Scala, 2nd Ed", 30, 4,10)
  val cardSale = new DutchAuction("100 POKEMON CARDS RARE!!!", 50, 2, 10)
