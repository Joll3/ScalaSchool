...
abstract class RobotBrain(initialName: String, val body: RobotBody) {
  ...
  /** Returns the coordinates that point at the square that is immediately in front 
    * of this robot. */
  def locationInFront: Coords = this.body.location.neighbor(this.facing)  // TODO: replace with a working implementation
  
  
  /** Returns the square that is immediately in front of this robot. */
  def squareInFront: Square = this.body.world.elementAt(this.body.location.neighbor(this.facing)) // TODO: replace with a working implementation
  ...
  //def robotInFront = this.squareInFront.robot.flatMap { x => x.brain } // TODO: replace with a working implementation
  def robotInFront = this.body.world.elementAt(this.locationInFront).robot.flatMap { x => x.brain }// TODO: replace with a working implementation
